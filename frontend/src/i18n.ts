...
const english = {
  ...
  files: {
    ...
    conflictTitle: 'File already exists', conflictBody: 'Choose what to do with {{name}}.',
    skip: 'Skip', replace: 'Replace', renameUpload: 'Upload with new name',
    selected: '{{count}} selected', downloadZip: 'Download ZIP', clearSelection: 'Clear selection',
  },
  shares: {
