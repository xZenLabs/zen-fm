...
const outputFile = path.join(frontendDirectory, 'src', 'locales', 'filebrowser.ts')
...
const banner = `// Generated by scripts/generate-filebrowser-locales.mjs from File Browser\n// commit 833d908884d5c801f30f5c098d7977177eb3a36b (Apache-2.0). Do not edit by hand.\n\n`
